  ...
  function ensureSticky() {
    ...
    bar.innerHTML =
      '<div class="stamps-sticky-inner">' +
        '<a class="stamps-sticky-btn stamps-sticky-call" href="tel:+16156298217" aria-label="Call One World Steel at 615-629-8217">' +
          ...
          '</span>' +
        '</a>' +
        '<a class="stamps-sticky-btn stamps-sticky-quote" href="' + quoteHref + '" aria-label="Request a quote">' +
          '<span class="stamps-sticky-icon" aria-hidden="true">' +
    ...
    if (!pop) {
      ...
      pop.innerHTML =
        ...
        '<div class="bldg-pop-body">' +
          ...
          '<a class="bldg-pop-cta" href="#">Request a quote</a>' +
        '</div>';
